		  ...
		  if (this.GWEN==true) {
			  for (Object entity : mc.theWorld.loadedEntityList) {
				  ...
				  if ((e.getPacket() instanceof S0CPacketSpawnPlayer)) {
					  ...
					  double difX = Minecraft.thePlayer.posX - posX;
					  double difY = Minecraft.thePlayer.posY - posY;
					  double difZ = Minecraft.thePlayer.posZ - posZ;

					  double dist = Math.sqrt(difX * difX + difY * difY + difZ * difZ);
					  if ((dist <= 17.0D) && (posX != Minecraft.thePlayer.posX) && (posY != Minecraft.thePlayer.posY) && (posZ != Minecraft.thePlayer.posZ)) {
