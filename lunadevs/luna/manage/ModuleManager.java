...
import lunadevs.luna.module.player.IRC;
...
import lunadevs.luna.module.render.NewNameTags;
import lunadevs.luna.module.render.OldNameTags;
...
public class ModuleManager {
	...
	//	mods.add(new Freecam());
		...
		/** 93 current active modules so far (91 when you count the 0), Thank me later.**/
	}
