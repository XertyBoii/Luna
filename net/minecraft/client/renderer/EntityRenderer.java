...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float p_78482_1_)
    {
        if (this.mc.func_175606_aa() instanceof EntityLivingBase)
        {
        	...
        	EventManager.call(eventHurtCam);
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if ((this.mc.gameSettings.viewBobbing) && !(ModuleManager.findMod(Tracers.class)).isEnabled()) {
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        if (!this.field_175078_W)
        {
            ...
            EventRender3D eventkek = new EventRender3D(partialTicks);
            EventManager.call(eventkek);
        ...
        RenderWorldEvent renderevent = new RenderWorldEvent(partialTicks);
