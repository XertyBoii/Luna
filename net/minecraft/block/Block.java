...
import lunadevs.luna.events.EventBoundingBox;
...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity)
    {
        ...
        EventCollision eventCollision = new EventCollision(collidingEntity, new Location(pos.getX(), pos.getY(), pos.getZ()), var7, this);
        EventManager.call(eventCollision);
        EventBoundingBox event = new EventBoundingBox(this, pos, var7);
